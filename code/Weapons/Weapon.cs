...
namespace OneMoreFloor.Weapons
{
	public partial class Weapon : BaseWeapon, IUse
	{
			...
			float bulletSize )
		{
			...
			//
			foreach ( var tr in this.TraceBullet( pos, pos + forward * 5000, bulletSize ) )
			{
		...
		{
			this.ShootBullet( Owner.EyePos, Owner.EyeRot.Forward, spread, force, damage, bulletSize );
		}
		...
		public virtual void ShootBullets( int numBullets, float spread, float force, float damage, float bulletSize )
		{
			...
			{
				this.ShootBullet( pos, dir, spread, force / numBullets, damage, bulletSize );
			}
		}
	}
}
